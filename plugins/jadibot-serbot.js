...
let rtx = `🌊 𝙂𝘼𝙒𝙍-𝙂𝙐𝙍𝘼-𝙈𝘿 𝘾𝙊𝙉𝙀𝙓𝙄Ó𝙉 🦈💙
> ✦ 𝙲𝙾𝙽𝙴𝚇𝙸Ó𝙽 𝚂𝚄𝙱-𝙱𝙾𝚃 (𝙼𝙾𝙳𝙾 𝚀𝚁) 🐟  

🦈✨ Escanea este *código QR mágico* con otro dispositivo o PC y convierte tu conexión en un *SUB-BOT marino activo*. 🌊  

➺ ❶ Abre los tres puntitos en la esquina superior.  
➺ ❷ Ve a *"Dispositivos vinculados"*.  
➺ ❸ Escanea el código QR y conéctate al bot acuático.  

⚠️ Este código QR expira en ⏳ ❺❹ segundos, ¡no pierdas tiempo, desu~! 💫
`;

let rtx2 = `🌊 𝙂𝘼𝙒𝙍-𝙂𝙐𝙍𝘼-𝙈𝘿 𝘾𝙊𝙉𝙀𝙓𝙄Ó𝙉 🦈💙
> ✦ 𝙲𝙾𝙽𝙴𝚇𝙸Ó𝙽 𝚂𝚄𝙱-𝙱𝙾𝚃 (𝙼𝙾𝙳𝙾 𝙲𝙾𝙳𝙸𝙶𝙾) 🐠  

💙 Usa este *código especial del océano* para transformarte en un *SUB-BOT temporal*.  

➺ ❶ Abre los tres puntitos en la esquina superior.  
➺ ❷ Ve a *"Dispositivos vinculados"*.  
➺ ❸ Introduce el código y únete a la marea del bot. 🌊  

⚠️ El código expira en ⏳ ❺❹ segundos, ¡apúrate, kouhai~! 🐟
`;
